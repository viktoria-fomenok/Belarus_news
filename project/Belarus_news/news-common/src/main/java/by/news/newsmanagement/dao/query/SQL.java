package by.epam.newsmanagement.dao.query;
...
public final class SQL {
    ...
    public static final String SQL_GET_ALL_NEWS = "SELECT news_id, news_title, news_short_text," +
            " news_full_text, news_creation_date, news_modification_date, news_version FROM NEWS";
    public static final String SQL_GET_NEWS_ON_ID = "SELECT news_id, news_title, news_short_text," +
            " news_full_text, news_creation_date, news_modification_date, news_version FROM NEWS WHERE news_id = ?";
    public static final String SQL_GET_ALL_NEWS_ON_CRITERIA = "SELECT news_id, news_title,"
            ...
            " comment_count, news_version  FROM NEWS INNER JOIN NEWS_AUTHORS ON NEWS.news_id = NEWS_AUTHORS.na_news_id LEFT" +
    ...
    public static final String SQL_CREATE_NEWS = "INSERT INTO NEWS( news_title, news_short_text,"
            + " news_full_text, news_creation_date, news_modification_date, news_version) VALUES(?,?,?,?,?,?)";
    public static final String SQL_UPDATE_NEWS = "UPDATE NEWS SET news_title = ?, news_short_text = ?,"
            + " news_full_text = ?, news_modification_date = ?, news_version = news_version + 1 WHERE news_id = ? AND news_version = ?";
    ...
    public static final String SQL_SORTING_BY_COMMENTS_AND_MODIFICATION_DATE_QUERY = " GROUP BY news_id, news_title," +
            ...
            " news_version order by  news_modification_date desc, comment_count desc";
    public static final String SQL_NEWS_PAGINATION_LEFT_QUERY = "SELECT news_id, news_title, news_short_text," +
            " news_full_text, news_creation_date, news_modification_date, news_version FROM ( SELECT rownum as rnum, news_id," +
            " news_title, news_short_text, news_full_text, news_creation_date, news_modification_date, news_version FROM (";
